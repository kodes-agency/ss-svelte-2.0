    ...
    <div class="flex flex-col items-center max-w-3xl w-full">
        {#if $message }           
            {#if $message.success === true }
                <div class="bg-brown rounded-sm max-w-md">
                    <div class="flex flex-col space-y-5 p-10">
                        <p class="text-white text-2xl text-center font-sansy">Вашето запитване е изпратено успешно!</p>
                        <p class="font-serif text-white">В най-кратък срок ще се свържем с Вас за да уточним необходимите детайли.</p>
                        <p class="font-serif text-white">С уважение,</p>
                        <p class="font-serif text-white">Екипът на винарско имение Санта Сара</p>
                    </div>
                </div>
            {:else if $message.success === false}
                <div class="bg-brown rounded-sm max-w-md">
                    <div class="flex flex-col space-y-5 p-10">
                        <p class="text-white text-2xl text-center font-sansy">Възникна грешка при изпращането на вашето запитване!</p>
                        <p class="font-serif text-white">Съжеляваме че не успяхме да приемем вашето запитване. Молим Ви, да се свържете с нас посредством посочените в долната част на страницата контактни данни.</p>
                        <p class="font-serif text-white">С уважение,</p>
                        <p class="font-serif text-white">Екипът на винарско имение Санта Сара</p>
                    </div>
                </div>
