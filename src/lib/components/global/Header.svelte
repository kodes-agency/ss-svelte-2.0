...
<header class="fixed top-0 w-full z-30">
    <div class="relative w-full">
        ...
        <div class="flex justify-between w-full pt-5 px-5 md:pt-10 md:px-10">
            ...
            <button
                class="z-50 relative flex flex-col items-center justify-center pb-5 pt-3 rounded-full px-2 transition-all duration-300 {$isInverted ? "bg-white" : "bg-transparent"}"
                on:click={()=>{
                    isOpen = !isOpen
                }}
            > 
