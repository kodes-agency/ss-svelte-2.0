<script lang="ts">
    ...
    import type { Menu } from "../../../__generated__/graphql";
  ...
  import { goto } from "$app/navigation";
    ...
    export let contacts: Maybe<string> | undefined;
...
<header class="fixed top-0 w-full z-30">
    <div class="relative w-full">
        <nav class="z-40 bg-white h-screen w-full absolute transition-transform duration-700 {isOpen ? " translate-y-0" : "-translate-y-full"}">
            <div class="flex flex-col items-center py-5 space-y-6 md:space-y-0 px-5 md:px-20 lg:px-40 justify-start md:justify-around h-full transition-opacity delay-300 duration-700 {isOpen ? "opacity-100" : "opacity-0"}">
        ...
        <div class="flex justify-between w-full pt-5 px-5 md:pt-10 md:px-10">
            ...
            <div class="flex space-x-4">
                <div>
                    <button class="transition-all duration-300 rounded-full px-2 py-2" 
                        on:click={()=>{
