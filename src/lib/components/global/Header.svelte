<script lang="ts">
    ...
    import type { Menu, Maybe } from "../../../__generated__/graphql";
    import type { Order } from "$lib/types/orderTypes";
    import Lang from "./Lang.svelte";
    import { goto } from "$app/navigation";
  import { fade, slide } from "svelte/transition";
    export let menu: Menu
    export let address1: Maybe<string> | undefined;
    export let address2: Maybe<string> | undefined;
    export let address3: Maybe<string> | undefined;
    export let email: Maybe<string> | undefined;
    export let phone: Maybe<string> | undefined;
    export let policy: Maybe<string> | undefined;
    export let gpdr: Maybe<string> | undefined;
...
<header class="fixed top-0 w-full z-30">
    <div class="relative w-full">
        <nav class="z-40 bg-white h-screen w-full absolute transition-transform duration-700 {isOpen ? " translate-y-0" : "-translate-y-full"}">
            <div class="flex flex-col items-center py-5 space-y-2 md:space-y-0 px-5 md:px-20 lg:px-40 justify-start md:justify-around h-full transition-opacity delay-300 duration-700 {isOpen ? "opacity-100" : "opacity-0"}">
                <a on:click={()=>{isOpen = false}} href="{$page.params.lang ? "/"+$page.params.lang : "/bg/"}" aria-label="Home page">
                    <svg class="w-20 md:w-auto" width="96" height="105" viewBox="0 0 96 105" fill="" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 w-full gap-y-5 md:gap-y-0 justify-between">
                    <div class="flex flex-col md:space-y-2 lg:space-y-4">
                        <p class="text-brown font-sansy uppercase text-xl text-center">{menu.wineEstate}</p>
                        <div class="flex flex-col items-center space-y-1">
                            <div class="group w-fit">
                                <a on:click={()=>{isOpen = false}} class="italic font-serif text-gray" href={$page.params.lang ? "/"+$page.params.lang + "/cellar" : "/bg/cellar"}>{menu.linkCeller}</a>
                                <div class="w-0 h-px bg-gray group-hover:w-full transition-all duration-500"></div>
                            </div>
                            <div class="group w-fit">
                                <a on:click={()=>{isOpen = false}} class="italic font-serif text-gray" href={$page.params.lang ? "/"+$page.params.lang + "/vineyard" : "/bg/vineyard"}>{menu.linkVinyard}</a>
                                <div class="w-0 h-px bg-gray group-hover:w-full transition-all duration-500"></div>
                            </div>
                            <div class="group w-fit">
                                <a on:click={()=>{isOpen = false}} class="italic font-serif text-gray" href={$page.params.lang ? "/"+$page.params.lang + "/visit" : "/bg/visit"}>{menu.linkVisits}</a>
                                <div class="w-0 h-px bg-gray group-hover:w-full transition-all duration-500"></div>
                            </div>
                        </div>
                    </div>
                    <div class="flex flex-col md:space-y-2 lg:space-y-4">
                        <p class="text-brown font-sansy uppercase text-xl text-center">{menu.ourWines}</p>
                        <div class="flex flex-col items-center space-y-1">
                            <div class="group w-fit">
                                <a on:click={()=>{isOpen = false}} class="italic font-serif text-gray" href={$page.params.lang ? "/"+$page.params.lang + "/wine?type=white" : "/bg/wine?type=white"}>{menu.linkWhites}</a>
                                <div class="w-0 h-px bg-gray group-hover:w-full transition-all duration-500"></div>
                            </div>
                            <div class="group w-fit">
                                <a on:click={()=>{isOpen = false}} class="italic font-serif text-gray" href={$page.params.lang ? "/"+$page.params.lang + "/wine?type=red" : "/bg/wine?type=red"}>{menu.linkReds}</a>
                                <div class="w-0 h-px bg-gray group-hover:w-full transition-all duration-500"></div>
                            </div>
                            <div class="group w-fit">
                                <a on:click={()=>{isOpen = false}} class="italic font-serif text-gray" href={$page.params.lang ? "/"+$page.params.lang + "/wine?type=rose" : "/bg/wine?type=rose"}>{menu.linkRoses}</a>
                                <div class="w-0 h-px bg-gray group-hover:w-full transition-all duration-500"></div>
                            </div>
                            <div class="group w-fit">
                                <a on:click={()=>{isOpen = false}} class="italic font-serif text-gray" href={$page.params.lang ? "/"+$page.params.lang + "/wine?type=collection" : "/bg/wine?type=collection"}>{menu.linkCollections}</a>
                                <div class="w-0 h-px bg-gray group-hover:w-full transition-all duration-500"></div>
                            </div>
                    ...
                    <div class="flex flex-col md:space-y-2 lg:space-y-4">
                        <p class="text-brown font-sansy uppercase text-xl text-center">{menu.contactUs}</p>
                        <div class="flex flex-col items-center space-y-1">
                            <div class="group w-fit">
                                <a on:click={()=>{isOpen = false}} class="italic font-serif text-gray" href={$page.params.lang ? "/"+$page.params.lang + "/b2b" : "/bg/b2b"}>{menu.linkB2b}</a>
                                <div class="w-0 h-px bg-gray group-hover:w-full transition-all duration-500"></div>
                            </div>
                            <div class="group w-fit">
                                <a on:click={()=>{isOpen = false}} class="italic font-serif text-gray" href={$page.params.lang ? "/"+$page.params.lang + "/contact" : "/bg/contact"}>{menu.linkContact}</a>
                                <div class="w-0 h-px bg-gray group-hover:w-full transition-all duration-500"></div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="flex flex-col md:space-y-2 lg:space-y-4 pt-2">
                    <p class="text-brown font-sansy uppercase text-xl text-center">{menu.aboutUs}</p>
                    <div class="flex flex-col lg:flex-row items-center lg:space-x-10">
                        <div class="group w-fit">
                            <a on:click={()=>{isOpen = false}} class="italic font-serif whitespace-nowrap text-gray" href={$page.params.lang ? "/"+$page.params.lang + "/about" : "/bg/about"}>{menu.linkPhilosophy}</a>
                            <div class="w-0 h-px bg-gray group-hover:w-full transition-all duration-500"></div>
                        </div>
                        <div class="group w-fit">
                            <a on:click={()=>{isOpen = false}} class="italic font-serif whitespace-nowrap text-gray" href={$page.params.lang ? "/"+$page.params.lang + "/about#history" : "/bg/about#history"}>{menu.linkHistory}</a>
                            <div class="w-0 h-px bg-gray group-hover:w-full transition-all duration-500"></div>
                        </div>
                        <div class="group w-fit">
                            <a on:click={()=>{isOpen = false}} class="italic font-serif whitespace-nowrap text-gray" href={$page.params.lang ? "/"+$page.params.lang + "/about#team" : "/bg/about#team"}>{menu.linkTeam}</a>
                            <div class="w-0 h-px bg-gray group-hover:w-full transition-all duration-500"></div>
                        </div>
                        <div class="group w-fit">
                            <a on:click={()=>{isOpen = false}} class="italic font-serif whitespace-nowrap text-gray" href={$page.params.lang ? "/"+$page.params.lang + "/diary" : "/bg/diary"}>{menu.linkDiary}</a>
                            <div class="w-0 h-px bg-gray group-hover:w-full transition-all duration-500"></div>
                        </div>
                        <div class="group w-fit">
                            <a on:click={()=>{isOpen = false}} class="italic font-serif whitespace-nowrap text-gray" href={$page.params.lang ? "/"+$page.params.lang + "/news" : "/bg/news"}>{menu.linkNews}</a>
                            <div class="w-0 h-px bg-gray group-hover:w-full transition-all duration-500"></div>
                        </div>
                    </div>
                </div>
                <address class="hidden md:flex flex-col items-center justify-center not-italic mt-2 space-y-2 md:space-y-5">
                    <div class="flex flex-col items-center justify-center md:space-y-1">
                        <p class="text-brown text-sm text-center font-serif ">{address1}</p>
                        <p class="text-brown text-sm text-center font-serif ">{address2} {address3}</p>
                        <div class="group w-fit">
                            <a on:click={()=>{isOpen = false}} class="text-brown text-sm text-center font-serif " href="tel:{phone}">{phone}</a>
                            <div class="w-0 h-px bg-gray group-hover:w-full transition-all duration-500"></div>
                        </div>
                        <div class="group w-fit">
                            <a on:click={()=>{isOpen = false}} class="text-brown text-sm text-center font-serif " href="mailto:{email}">{email}</a>
                            <div class="w-0 h-px bg-gray group-hover:w-full transition-all duration-500"></div>
                        </div>
                    </div>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-1 md:gap-10">
                        <div class="group w-fit">
                            <a on:click={()=>{isOpen = false}} class="text-brown text-sm font-serif italic text-center" href={$page.params.lang ? "/"+$page.params.lang + "/gdpr" : "/bg/gdpr"}>{gpdr}</a>
                            <div class="w-0 h-px bg-gray group-hover:w-full transition-all duration-500"></div>
                        </div>
                        <div class="group w-fit">
                            <a on:click={()=>{isOpen = false}} class="text-brown text-sm font-serif italic text-center" href={$page.params.lang ? "/"+$page.params.lang + "/policy" : "/bg/policy"}>{policy}</a>
                            <div class="w-0 h-px bg-gray group-hover:w-full transition-all duration-500"></div>
                        </div>
                    </div>
                </address>
        ...
        <div class="flex justify-between w-full pt-5 px-5 md:pt-10 md:px-10">
            ...
            <div class="flex space-x-4">
                ...
                <button
                    class="z-50 relative flex flex-col items-center justify-center pb-5 pt-3 px-2 transition-all duration-300 rounded-full {$isInverted ? "bg-white" : "bg-transparent"}"
                    on:click={()=>{
                        isOpen = !isOpen                        
                    }}
                > 
                    <div class="h-[2px] w-6 transition-all duration-300 bg-brown {isOpen ? "rotate-45" : "rotate-0"}"></div>
                    <div class="h-[2px] w-6 transition-all duration-300 bg-brown translate-y-1 {isOpen ? "opacity-0" : "opacity-100"}"></div>
                    <div class="h-[2px] w-6 transition-all duration-300 bg-brown {isOpen ? "-translate-y-1 -rotate-45" : "translate-y-2 rotate-0"}"></div>
                </button>
            </div>
        </div>
    </div>
