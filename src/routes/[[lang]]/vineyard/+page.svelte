<script lang="ts">
  ...
  import type { VinyardPage } from "../../../__generated__/graphql.js";
  ...
  let pageData: VinyardPage;
  $: pageData = data.data?.vinyardPage?.data?.attributes;
  $isInverted = true;
</script>
...
/>
<Layout layout={pageData.vinyardPageLayout} />
