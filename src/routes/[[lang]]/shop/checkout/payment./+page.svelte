...
<script lang='ts'>
    ...
    const translations = {
        bg: [
            ...
            {
                status: [402, 400],
                heading: "Поръчката е неуспешна! Референтен номер: ",
        ...
        en: [
            ...
            {
                status: [402, 400],
                heading: "Order unsuccessful! Ref number: ",
...
<div class="pt-28 md:pt-40 flex flex-col space-y-10 items-center justify-center p-5">
    {#if data.code === 201}
        <div class="p-10 rounded-sm bg-brown max-w-md flex flex-col items-center *:text-white *:text-center space-y-4">
            ...
            <h1 class="font-sansy bold text-2xl">#{data.orderNumber}</h1>
    ...
    {:else if data.code === 402 || data.code === 400}
        <div class="p-10 rounded-sm bg-brown max-w-md flex flex-col items-center *:text-white *:text-center space-y-4">
            ...
            <h1 class="font-sansy bold text-2xl">{data.lang === 'bg' ? translations.bg[1].heading : translations.en[1].heading} {data.orderNumber}</h1>
